							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="hungary" href="#"><span class="img label-before"><img src="assets/images/lang-kaz.png" width="20px" alt="lang-kaz"></span>Kazakh</a></li>
									</ul>
								</li>
										...
										<div class="wrap-icon-section minicart">
											<a href="/cart" class="link-direction">
												...
												<div class="left-info">
													...
													@endif
													<span class="title" style="color:crimson !important;">CART</span>
												</div>
											</a>
										</div>
